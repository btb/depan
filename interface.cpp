...
extern "C" __declspec(dllexport) const char* __stdcall AvisynthPluginInit2(IScriptEnvironment* env) {
    ...
    env->AddFunction("DePanStabilize", "c[data]c[cutoff]f[damping]f[initzoom]f[addzoom]b[prev]i[next]i[mirror]i[blur]i[dxmax]f[dymax]f[zoommax]f[rotmax]f[subpixel]i[pixaspect]f[fitlast]i[tzoom]f[info]b[inputlog]s[vdx]s[vdy]s[vzoom]s[vrot]s[method]i", Create_DePanStabilize, 0);
